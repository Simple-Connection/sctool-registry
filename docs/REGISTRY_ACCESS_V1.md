...
docs/policy/registry/registry-policy.json schemaVersion 2.0.0
```

`docs/ver1.0.1/history/REGISTRY_CONTRACT_V1.md` and `docs/ver1.0.1/history/schemas/policy-v1.schema.json` are retained as historical v1 references for the earlier anonymous-download model.
